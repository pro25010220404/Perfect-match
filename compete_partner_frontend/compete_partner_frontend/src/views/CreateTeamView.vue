        ...
        <transition name="slide-fade" mode="out-in">
          ...
          <div v-else-if="currentStep === 1" key="step2" class="step-content">
            <div class="step-header">
              ...
              <div>
                <h2 class="step-title">团队描述</h2>
                <p class="step-desc">详细介绍团队和期望的技能方向</p>
              </div>
            </div>
          ...
          <!-- 步骤4: 完成 -->
          <div v-else key="step4" class="step-content">
...
const steps = ['基本信息', '团队描述', '角色需求', '确认完成']
...
@media (max-width: 768px) {
  ...
  .form-grid.single-col .full-width {
    grid-column: 1;
  }
