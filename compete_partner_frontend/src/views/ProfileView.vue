    ...
    <div class="info-grid">
      ...
      <div class="card info-card">
        <div class="card-header">
          <h3 class="card-title">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--nav-blue-dark)" stroke-width="2">
        ...
        <div class="teams-grid">
          <div v-for="team in myTeams" :key="team.id" class="team-card-mini">
            <div class="team-cover" :style="{ background: team.gradient }">
              <span class="team-emoji"><LineIcon :name="team.emoji" :size="40" /></span>
            </div>
            <div class="team-body">
              <div class="team-top">
              ...
              <div class="team-bottom">
                ...
                <button class="btn-action" :class="team.status === '已结束' ? 'btn-secondary' : 'btn-primary'" @click="handleEnterTeam(team)">
    ...
    <section class="reviews-section card">
      ...
      <div class="card-body">
            ...
            <div class="review-content">
              <div class="review-header">
                <div class="reviewer-info">
                  ...
                  <span class="team-link">{{ review.teamName }}</span>
                </div>
        ...
        <div class="reviews-footer">
          <button class="btn btn-outline" @click="handleMoreReviews">查看更多评价</button>
        </div>
      </div>
    </section>
...
const skills = ref([
  { name: 'Python', level: 4, gradient: 'linear-gradient(90deg, #5EB3E4, #3D9FD4)' },
  { name: 'C++', level: 3, gradient: 'linear-gradient(90deg, #7EC5EF, #5EB3E4)' },
  { name: '机器学习', level: 5, gradient: 'linear-gradient(90deg, #3D9FD4, #2C8FC0)' },
  { name: '算法设计', level: 4, gradient: 'linear-gradient(90deg, #5EB3E4, #3D9FD4)' },
  { name: '数据分析', level: 3, gradient: 'linear-gradient(90deg, #7EC5EF, #5EB3E4)' }
])
...
const reviews = ref([
  {
    name: '李明',
    initial: '李',
    avatarGradient: 'linear-gradient(135deg, #5EB3E4, #3D9FD4)',
    teamName: '无人车战队',
    date: '2025-04-15',
    qualityScore: 5,
    contributionScore: 5,
  ...
  },
  {
    name: '王芳',
    initial: '王',
    avatarGradient: 'linear-gradient(135deg, #7EC5EF, #5EB3E4)',
    teamName: 'AI创新赛',
    date: '2025-03-20',
    qualityScore: 5,
    contributionScore: 4,
...
const gradients = [
  'linear-gradient(90deg, #5EB3E4, #3D9FD4)',
  'linear-gradient(90deg, #7EC5EF, #5EB3E4)',
  'linear-gradient(90deg, #3D9FD4, #2C8FC0)',
  'linear-gradient(90deg, #6BB3E2, #4AA9DA)',
  'linear-gradient(90deg, #5EB3E4, #3D9FD4)',
  'linear-gradient(90deg, #7EC5EF, #5EB3E4)',
  'linear-gradient(90deg, #3D9FD4, #2C8FC0)'
]
...
function handleAddSkill() {
  ...
  if (skills.value.some((s) => s.name === newSkill.name)) {
    toast('该技能已存在')
    return
  }
...
.avatar-xl {
  ...
  height: 96px;
  border-radius: 50%;
  background: linear-gradient(135deg, #5EB3E4 0%, #3D9FD4 100%);
  display: flex;
  align-items: center;
  ...
  box-shadow: 0 8px 24px rgba(94, 179, 228, 0.25);
